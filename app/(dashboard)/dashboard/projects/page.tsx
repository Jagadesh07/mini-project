      ...
      <Card title="Project Portfolio" eyebrow="Scope" className="animate-rise-delay-2">
        <div className="grid gap-4 md:grid-cols-2">
          {dashboard.projects.map((project: any, index: number) => (
            <div key={String(project._id)} className="relative overflow-hidden rounded-[1.6rem] border border-slate-200/80 bg-white/75 p-5 backdrop-blur dark:border-slate-700 dark:bg-slate-950/45">
